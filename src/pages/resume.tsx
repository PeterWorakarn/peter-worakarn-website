...
const Back = dynamic(import('../features/components/Back'), {ssr: true});
const FAB = dynamic(import('../features/components/FAB'), {ssr: true});
const ResumeContainer = dynamic(import('../features/ResumeContainer'), {ssr: true});
