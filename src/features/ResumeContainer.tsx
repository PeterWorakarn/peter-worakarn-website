...
const ResumeContainer: React.FC = () => {
  ...
  return (
    <article className="flex flex-col bg-opacity-70 bg-app_white backdrop-blur-md border-t-[20px] border-primary_blue border-opacity-25 print:border-none h-full max-w-3xl mx-auto p-10 sm:p-16 print:p-0 rounded-md">
      {/* Start Header */}
